...
const defaultImage =
  "https://images.unsplash.com/photo-1621504450181-5d356f61d307?auto=format&fit=crop&w=687&q=80";

let windowSizeMobile = window.matchMedia("(max-width: 576px)");

const News = ({ simplified }) => {
  const [newsCategory, setNewsCategory] = useState("Cryptocurrency");
  const { data: coinNews } = useGetCoinNewsQuery({
    newsCategory,
            ...
            <a href={news.url} target="_blank" rel="noreferrer">
              <div className="news-image-container">
                <Title className="news-title" level={4}>
                  {news.name.length > 50 && windowSizeMobile
              ...
              <div className="provider-container">
                ...
                <Text>
                  ...
                  {dayjs(news.datePublished).fromNow(true)}
                </Text>
              </div>
            </a>
          </Card>
